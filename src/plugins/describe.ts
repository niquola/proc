...
export default async function (_ctx: Context, _session: Session | null, opts: { dir: string; namespace: string; manifest: any }): Promise<{ label: string; icon: string; description: string; skill: string | null }> {
